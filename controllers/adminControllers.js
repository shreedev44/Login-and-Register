...
const loadLogin = async (req, res) => {
    try {
        ...
        res.render('adminlogin', { PasswordStatus: pass, AdminStatus: admin, logoutStatus: logout, title: 'Admin Login' });
    }
    catch (error) {
...
const loadHome = async (req, res) => {
    try {
        ...
        return res.render('admindashboard', { admin: admin, title: 'Dashboard', ProfileChange: profile, PasswordChange: pass });
    }
    catch (error) {
        console.log(error.message);
    }
